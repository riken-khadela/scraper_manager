"""
Django settings for Scraper Management Dashboard.
"""
...
SECRET_KEY = env.get('SECRET_KEY', 'django-insecure-fallback-key-change-me')
...
MONGO_DEFAULT_DB = env.get('MONGO_DEFAULT_DB', 'scrapers_db')
